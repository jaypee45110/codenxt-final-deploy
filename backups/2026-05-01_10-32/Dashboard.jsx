...
shortLink: '',
  ...
  const statusStorageKey = eventData?.eventCode
    ...
    en: {
      ...
      subtitle: 'Manage live access, QR visibility, reward setup, and core event actions from one clean control surface.',
      venue: 'Venue',
      city: 'City',
      date: 'Date',
...
if (selectedRewardType === 'url') {
  ...
  const res = await fetch(`${API_BASE}/upload-reward-file`, {
    method: "POST",
    body: formData,
  });
...
>
<div style={{ fontSize: 14, opacity: 0.7 }}>Screen window</div>
<div style={{ fontSize: 11, opacity: 0.6 }}>Drag to external screen</div>
<button
  id="fullscreenButton"
  style={{
    backgroundColor: '#4da3ff',
