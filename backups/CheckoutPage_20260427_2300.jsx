...
const eventData = JSON.parse(rawEventResponse);
    ...
    fetch(`${API_BASE}/generate-screen-video`, {
      method: 'POST',
      ...
      .then((res) => res.json())
      .then((prepareData) => {
        console.log('SCREEN VIDEO PREP RESPONSE:', prepareData);

        if (prepareData?.ok && prepareData?.videoUrl) {
          const updatedPayload = {
            ...payload,
            screenVideoUrl: prepareData.videoUrl,
          };
          localStorage.setItem('codenxt_event', JSON.stringify(updatedPayload));
        }
      })
      .catch((err) => {
        console.error('Screen video generation failed:', err);
      });
        ...
        <div style={styles.contentGrid}>
              ...
              <div style={styles.twoCol}>
                ...
                <div style={{ ...styles.fieldBlock, gridColumn: '1 / -1' }}>
                  <label style={styles.label}>
                    Upload Artist logo / image (optional)
                  </label>
          ...
          <div style={styles.rightColumn}>
            ...
            <div style={styles.card}>
              ...
              <p style={styles.cardText}>
                This is a visual placeholder for the payment step.Not neccesary to fill in
              </p>
