...
# INPUT
# -----------------------------
event_code = sys.argv[1] if len(sys.argv) > 1 else "CT-DEMO"
lang = sys.argv[2] if len(sys.argv) > 2 else "en"
artist_name = sys.argv[3] if len(sys.argv) > 3 else "ARTIST NAME"
venue_name = sys.argv[4] if len(sys.argv) > 4 else "VENUE NAME"
event_date = sys.argv[5] if len(sys.argv) > 5 else "EVENT DATE"
...
frame_path = "src/assets/round-badges/americana.png"
