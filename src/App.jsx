...
function BrandHeader({ lang, setLang }) {
  ...
  return (
    <header className="brand-header">
      <Link to="/" className="brand-lockup" aria-label="codeStack">
        <img src="/codestack-logo.png" alt="codeStack logo" className="brand-logo" />
...
function HomePage({ lang, setLang }) {
  ...
  useEffect(() => {
    document.title = 'codeStack powered by codeNXT';
  }, []);
