...
const bonusCopy = {
  ...
  en: {
    ...
    rewardPending: 'The benefit appears on the certificate after registration.',
    verifiedBenefit: 'VERIFIED BENEFIT',
    rewardPending: 'Fordelen vises på sertifikatet etter registrering.',
    verifiedBenefit: 'VERIFISERT FORDEL',
  ...
  de: {
    ...
    rewardPending: 'Der Vorteil erscheint nach der Registrierung auf dem Zertifikat.',
    verifiedBenefit: 'VERIFIZIERTER VORTEIL',
  ...
  fr: {
    ...
    rewardPending: 'L’avantage apparaît sur le certificat après l’inscription.',
    verifiedBenefit: 'AVANTAGE VÉRIFIÉ',
  ...
  es: {
    ...
    rewardPending: 'El beneficio aparece en el certificado después del registro.',
