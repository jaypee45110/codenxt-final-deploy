...
const bonusCopy = {
  no: {
    ...
    ownershipKicker: 'VERIFISERT MEDLEMSFORDEL',
  ...
  en: {
    ...
    ownershipKicker: 'VERIFIED MEMBER BENEFIT',
  ...
  de: {
    ...
    ownershipKicker: 'VERIFIZIERTER MITGLIEDERVORTEIL',
    ownershipLabel: 'Zertifikat-ID',
    ownershipDescription: 'Dieser Mitgliedervorteil wurde dauerhaft im codePerks-Netzwerk registriert.',
  ...
  fr: {
    ...
    ownershipKicker: 'AVANTAGE MEMBRE VÉRIFIÉ',
    ownershipLabel: 'ID du certificat',
    ownershipDescription: 'Cet avantage membre est enregistré de manière permanente dans le réseau codePerks.',
  ...
  es: {
    ...
    ownershipKicker: 'BENEFICIO DE MIEMBRO VERIFICADO',
    ownershipLabel: 'ID del certificado',
    ownershipDescription: 'Este beneficio para miembros ha sido registrado permanentemente en la red codePerks.',
