          ...
          <div className="main-grid">
            ...
            <section className="panel report-panel compact-report">
              ...
              <div className="button-row report-buttons">
                <button type="button" className="ghost-button" onClick={fetchReport}>
                  {text.viewReport}
                </button>
              ...
              <div className="status">{reportMessage}</div>
            </section>
            </div>
            ...
            <section className="panel bonus-panel">
              <div className="bonus-header">
                ...
                <label className="tier-count">
                  <span className="label">{text.tierCount}</span>
                  <select
                    value={tierCount}
                    onChange={(event) => {
                      const nextCount = Number(event.target.value);
                      setTierCount(nextCount);

                      if (nextCount === 1) setActiveTier('gold');
                      if (nextCount === 2 && activeTier === 'general') setActiveTier('silver');
                    }}
                  >
                    <option value={1}>{text.tierCount1}</option>
                    <option value={2}>{text.tierCount2}</option>
                    <option value={3}>{text.tierCount3}</option>
                  </select>
                </label>
              </div>
              ...
              <div className="bonus-editor">
                ...
                <div className="status">{bonusMessage || activeDraft.fileName || activeDraft.url}</div>
              </div>
            </section>
          </div>
